...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $settings = [
            ...
            ['key' => 'facebook_url', 'value' => 'https://facebook.com/pzumedica', 'group' => 'social'],
        ...
        $sections = [
            [
                ...
                'data' => [
                    ...
                    'description' => 'Цели 27 години "ПЗУ Медика" работи во голем за зачувување и унапредување на здравјето на своите пациенти. Започна како Ординација по Општа Медицина се развиваше постепено зголемувајќи го својот број на вработени и соделници на стручност.',
            ...
            [
                ...
                'data' => [
                    'locations' => [
                        ['department' => 'Општа и Психијатриска Ординација', 'hours' => 'Пон до Петок 08:00 - 15:00', 'address' => 'Вањо Китанов бр. 19', 'phone' => '034-360-444', 'doctor' => ''],
                        ['department' => 'Општа и Трудова Ординација', 'hours' => 'Пон до Петок 08:00 - 20:00', 'address' => '', 'phone' => '034-326-301', 'doctor' => 'Ганче Пешев'],
            ...
            [
                ...
                'data' => [
                    ...
                    'facebook' => 'https://facebook.com/pzumedica',
                    'instagram' => '',
                ],
                'is_active' => true,
            ],
