...
// Get existing English translations if available
const enTranslations = (props.dose.translations || []).reduce((acc, t) => {
    if (t.locale === 'en') acc[t.field] = t.value;
    return acc;
}, {});
...
const form = useForm({
    ...
    excerpt_en: enTranslations.excerpt || '',
                        ...
                        <div class="card-body p-4">
                            ...
                            <div v-show="activeTab === 'en'">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea v-model="form.excerpt_en" rows="2" class="form-control"></textarea>
                                </div>
